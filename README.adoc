...
image:https://img.shields.io/maven-central/v/sk.ainet.core/skainet-lang-api.svg[Maven Central,link=https://central.sonatype.com/artifact/sk.ainet.core/skainet-lang-api]
