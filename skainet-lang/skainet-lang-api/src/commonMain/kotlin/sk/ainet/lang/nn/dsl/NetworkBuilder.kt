...
public interface TensorsValueScope<T : DType, V> {
    ...
    public fun random(random: Random): Tensor<T, V> = factory.random(shape, random)
    ...
    public fun randomNormal(mean: Double = 0.0, std: Double = 1.0, random: Random): Tensor<T, V> =
    ...
    public fun randomUniform(min: Double = 0.0, max: Double = 1.0, random: Random): Tensor<T, V> =
