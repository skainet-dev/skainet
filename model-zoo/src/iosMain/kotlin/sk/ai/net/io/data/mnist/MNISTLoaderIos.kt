 ...
 */
class MNISTLoaderIos(config: MNISTLoaderConfig) : MNISTLoaderCommon(config) {
    ...
    companion object {
         ...
         * @return A new instance of MNISTLoaderIos.
         */
        fun create(cacheDir: String): MNISTLoaderIos {
         ...
         * @return A new instance of MNISTLoaderIos.
         */
        fun create(config: MNISTLoaderConfig): MNISTLoaderIos {
