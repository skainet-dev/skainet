 ...
 */
class MNISTLoaderAndroid(config: MNISTLoaderConfig) : MNISTLoaderCommon(config) {
    ...
    companion object {
         ...
         * @return A new instance of MNISTLoaderAndroid.
         */
        fun create(cacheDir: String): MNISTLoaderAndroid {
         ...
         * @return A new instance of MNISTLoaderAndroid.
         */
        fun create(config: MNISTLoaderConfig): MNISTLoaderAndroid {
