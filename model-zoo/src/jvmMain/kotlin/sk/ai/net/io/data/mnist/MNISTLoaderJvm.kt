 ...
 */
class MNISTLoaderJvm(config: MNISTLoaderConfig) : MNISTLoaderCommon(config) {
    ...
    companion object {
         ...
         * @return A new instance of MNISTLoaderJvm.
         */
        fun create(cacheDir: String): MNISTLoaderJvm {
         ...
         * @return A new instance of MNISTLoaderJvm.
         */
        fun create(config: MNISTLoaderConfig): MNISTLoaderJvm {
