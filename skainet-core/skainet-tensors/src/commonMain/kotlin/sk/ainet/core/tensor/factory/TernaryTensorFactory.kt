...
public object TernaryTensorFactory : TensorFactoryRegistry.TensorFromBytesFactory<Ternary, Byte> {
    ...
    /**
     * Creates a tensor from byte data with packed Ternary values.
     *
     ...
     */
    override fun fromByteArray(shape: Shape, data: ByteArray, littleEndian: Boolean): Tensor<Ternary, Byte> {
